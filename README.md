...
Check out the results that I have provided for detailed analysis.

I have implemented lot of machine learning algorithms (Generalized boosted regression, linear discriminant analysis, random forest, logistic 
regression, support vector machine, etc) and cross validate all results.
